...
namespace  Pet.Tracker
{
    ...
    public class EntryControl : Entry
    {
        ...
        public static readonly BindableProperty ImageProperty =
            BindableProperty.Create(nameof(Image), typeof(string), typeof(EntryControl), string.Empty);
        ...
        public static readonly BindableProperty ImageAlignmentProperty =
            BindableProperty.Create(nameof(ImageAlignment), typeof(ImageAlignment), typeof(EntryControl), ImageAlignment.Left);
