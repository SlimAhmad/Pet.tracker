...
namespace Pet.Tracker
{
    ...
    public class TransferPetViewModel : BaseViewModel
    {
        ...
        public MissingPetsApiModel SelectedItem
        {
            ...
            set
            {
                ...
                if (Selected != value)
                {
                    ...
                    // Go to register page?
                    ViewModelApplication.GoToPageAsync(ApplicationPage.PTDetails, null, true, false, parameter);
